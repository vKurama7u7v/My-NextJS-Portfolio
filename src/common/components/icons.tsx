...
export const GetIconComponent = ({ search, className }: GetIconProps) => {
  switch (search) {
    case 'nextjs':
    ...
    case 'nest':
      return <NestIcon className={className} />
    default:
      return null
  }
}
...
export const MenuSquareIcon = ({ className }: IconProps) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="1em"
...
export const InstragramIcon = ({ className }: IconProps) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="1em"
...
export const NestIcon = ({ className }: IconProps) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="1em"
